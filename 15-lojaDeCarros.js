...
Ele deseja comprar um carro hatch, e a revenda possui,
 ...
 caso o comprador queira o hatch,
retorne: “Compra efetuada com sucesso”.
Nas outras opções, retorne: “Tem certeza que não 
prefere este modelo?”.
Caso seja especificado um modelo que 
...
console.log(lojaDeCarros('sedans'))
console.log(lojaDeCarros('motocicletas'))
console.log(lojaDeCarros('caminhonetes'))
console.log(lojaDeCarros('tratores'))
